    ...
    return (
        <div className="min-h-screen bg-gray-50/50 pb-24">
            ...
            <div className="bg-white border-b py-4">
                <Container>
                    <Link href="/services" className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-blue-600 transition-colors">
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
                            <div className="flex flex-col md:flex-row justify-between gap-6 mb-8">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-3xl font-extrabold text-blue-600">{provider.priceRange}</p>
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden sticky top-24">
                            <div className="bg-blue-600 p-8 text-white">
                                ...
                                <p className="text-blue-100 text-sm opacity-90 font-medium">No payment needed today. Request a free quote!</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border-gray-200 p-4 text-sm focus:border-blue-500 font-bold transition-all"
                                    />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-xl border-gray-200 p-4 text-sm focus:border-blue-500 transition-all resize-none font-medium"
                                    />
                                </div>

                                <Button
                                    type="submit"
                                    className="w-full py-4 rounded-xl text-lg font-bold shadow-lg shadow-blue-200"
